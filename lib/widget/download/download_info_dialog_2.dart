...
class DownloadInfoDialogNew extends StatefulWidget {
  final DownloadItem downloadItem;
  final bool showActionButtons;
  final bool showFileActionButtons;
  final bool showSupportsPause;

  const DownloadInfoDialogNew(
    this.downloadItem, {
    super.key,
  ...
  @override
  State<DownloadInfoDialogNew> createState() => _DownloadInfoDialogNewState();
}

class _DownloadInfoDialogNewState extends State<DownloadInfoDialogNew>
